...
HANDLE Cport[28]; //#added support for COM17-COM28


char comports[28][10]={"\\\\.\\COM1",  "\\\\.\\COM2",  "\\\\.\\COM3",  "\\\\.\\COM4",
                       "\\\\.\\COM5",  "\\\\.\\COM6",  "\\\\.\\COM7",  "\\\\.\\COM8",
                       "\\\\.\\COM9",  "\\\\.\\COM10", "\\\\.\\COM11", "\\\\.\\COM12",
                       "\\\\.\\COM13", "\\\\.\\COM14", "\\\\.\\COM15", "\\\\.\\COM16",
					   "\\\\.\\COM17", "\\\\.\\COM18", "\\\\.\\COM19", "\\\\.\\COM20", //Added COM17-COM28
...
int RS232_OpenComport(int comport_number, int baudrate, const char *mode)
{
  ...
  switch(baudrate)
  {
    ...
    case  500000 : strcpy(mode_str, "baud=500000");
                   break;
	case  921600 : strcpy(mode_str, "baud=921600"); //Added standard baudrate
                   break;
...
*/
  ...
  {
    // Added printout of setting string.
    printf("unable to set comport dcb settings: '%s'\n",mode_str);
...
{
  int n;
  ClearCommError(Cport[comport_number],(LPDWORD)((void *)&n),NULL);
